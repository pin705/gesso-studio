# Game Art Knowledge Base

The rules an AI artist follows to make game-ready assets that look hand-crafted. Read topics with `read_guide(["topic", ...])`; load only what the current task needs.
...
| `fundamentals/shape` | Silhouettes, shape language, detail hierarchy, composition. |
| `fundamentals/materials` | Rendering metal, gems, jade, glass, wood, stone, cloth, energy. |
| `fundamentals/svg-craft` | SVG techniques and pitfalls: layering, bevels, textures, glow, animation. |
| `asset-types/button` | Buttons and their states. |
| `asset-types/panel` | Panels, windows, frames, cards (9-slice). |
